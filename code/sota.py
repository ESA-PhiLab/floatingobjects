...
testimagedataset = FloatingSeaObjectDataset(data_path, fold="val", transform=None,
                                            output_size=image_size)

# dataset for training with no transform
imagedataset = FloatingSeaObjectDataset(data_path, fold="val", transform=None,
                                        output_size=image_size, hard_negative_mining=False, use_l2a_probability=1)
####
...
conf_mat = confusion_matrix(y_true_svm_flat[idx], y_pred_svm_flat)
print(conf_mat)
...
conf_mat = confusion_matrix(y_true_rf_flat[idx], y_pred_rf_flat)
metrics(conf_mat,LABELS)
...
conf_mat = confusion_matrix(y_true_nb_flat[idx], y_pred_nb_flat)
metrics(conf_mat,LABELS)
